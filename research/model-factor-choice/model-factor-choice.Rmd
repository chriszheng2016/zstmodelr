...
if (all(c("factor_name","factor_value") %in% names(fundamental_factors_raw))) {
  fundamental_factors_raw <- fundamental_factors_raw %>%
   dplyr::select(date, stkcd, indcd, factor_name, factor_value) %>%
...
# prepare dataset for lagging factors
...
# lagging factors with lag setting of factors
ds_lag_factors <- ds_lag_factors %>%
...
# combine lagged factors datasets into one dataset
