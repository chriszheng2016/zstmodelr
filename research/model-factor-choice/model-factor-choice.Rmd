...
rds_file_factor_test <- sprintf(
  "ds_factor_test_(%s).rds",
  params$factor_group
)
csv_file_factor_test <- sprintf(
  "ds_factor_test_(%s).csv",
  params$factor_group
)
saveRDS(ds_factor_test,
  file = file.path("temp", rds_file_factor_test)
)

readr::write_csv(ds_factor_test,
  path = file.path("temp", csv_file_factor_test)
)
